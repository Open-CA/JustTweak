...
//    tweakProviders.append(ephemeralTweakProvider_1)
    ...
    let userDefaultsTweakProvider_1 = UserDefaultsConfiguration(userDefaults: UserDefaults.standard)
    ...
    //        let localTweakProvider_1 = LocalConfiguration(jsonURL: jsonFileURL_1)
    ...
    let localTweakProvider_2 = LocalConfiguration(jsonURL: jsonFileURL_2)
    tweakProviders.append(localTweakProvider_2)

    let tweakManager = TweakManager(configurations: tweakProviders)
